            ...
            <thead>
                <tr>
                    <th class="text-left font-weight-bold">
                        {{ t("tableOfProfiles.header.th1") }}
                    </th>
                    <th class="text-left font-weight-bold">
                        {{ t("tableOfProfiles.header.th2") }}
                    </th>
                    <th class="text-left font-weight-bold">
                        {{ t("tableOfProfiles.header.th3") }}
                    </th>
                </tr>
            </thead>

            <tbody>
                <tr v-for="(item, index) in props.items" :key="item.name">
                            ...
                            <v-menu open-on-hover>
                                <template v-slot:activator="{ props }">
                                    <p v-bind="props">
                                        <img
                                            ...
                                            :alt="
                                                t(
                                                    'tableOfProfiles.body.takeALook',
                                                )
                                            "
                                        />
                                    </p>
                                ...
                                <v-list style="overflow: hidden">
                                    ...
                                    <v-list-item v-else>
                                        <v-list-item-title>{{
                                            t(
                                                "tableOfProfiles.body.noAssociatedGenre",
                                            )
                                        }}</v-list-item-title>
                                    </v-list-item>
                                </v-list>
